...
public class DualCellHandler implements ICellHandler {
    public static final DualCellHandler INSTANCE = new DualCellHandler();

    @Override
    public boolean isCell(ItemStack is) {
        return DualCellInventory.isCell(is);
    }

    @Override
    public @Nullable DualCellInventory getCellInventory(ItemStack is, @Nullable ISaveProvider host) {
        return DualCellInventory.createInventory(is, host);
    }
