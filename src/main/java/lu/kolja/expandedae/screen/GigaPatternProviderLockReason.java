...
public class GigaPatternProviderLockReason implements ICompositeWidget {
    protected boolean visible = false;
    protected int x;
    protected int y;

    private final GigaPatternProviderScreen<?> screen;

    public GigaPatternProviderLockReason(GigaPatternProviderScreen<?> screen) {
        this.screen = screen;
    }
