...
public class MegaPatternProviderUpgradeItem extends UpgradeItem {
    public MegaPatternProviderUpgradeItem(Properties pProperties) {
        super(pProperties);
    }

    @Override
    public void appendHoverText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag advancedTooltips) {
        tooltip.add(ExpLang.ITEM_UPGRADE_TOOLTIP.text("a Mega Pattern Provider to an Expanded Pattern Provider")
    ...
    public @NotNull InteractionResult useOn(@NotNull UseOnContext context) {
        return replace(context,
                MEGAPatternProviderBlockEntity.class, ExpBlockEntities.EXP_PATTERN_PROVIDER, ExpBlocks.EXP_PATTERN_PROVIDER,
                MEGAItems.MEGA_PATTERN_PROVIDER.asItem().getPartClass(), ExpItems.EXP_PATTERN_PROVIDER_PART.asItem());
    }
}
